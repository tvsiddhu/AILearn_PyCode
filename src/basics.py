...
baseball = pd.read_csv("../data/baseball.csv")[['Height', 'Weight', 'Age']].to_numpy().tolist()
n = len(baseball)
...
fifa = pd.read_csv("../data/fifa.csv", skipinitialspace=True, usecols=['position', 'height'])
